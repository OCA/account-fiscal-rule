    ...
    def button_update_products(self, cr, uid, ids, context=None):
        ...
        for fiscal_classification in self.browse(cr, uid, ids):
            property_ids = self.pool.get('ir.property').search(
                cr, uid, [('name', '=', 'property_fiscal_classification'),
...
class wizard_account_product_fiscal_classification(osv.osv_memory):
    ...
    def action_create(self, cr, uid, ids, context=None):
        ...
        obj_fc_template = self.pool.get('account.product.fiscal.classification.template')
        ...
        for fclass_template in obj_fc_template.browse(cr, uid, fclass_ids_template):
            
            fclass_id = obj_fc.search(cr, uid, [('name','=',fclass_template.name)])
