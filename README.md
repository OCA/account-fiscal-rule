...
--- | --- | --- | ---
[account_avatax_exemption](account_avatax_exemption/) | 14.0.2.0.0 |  | This application allows you to add exemptions to Avatax
...
[account_avatax_oca](account_avatax_oca/) | 14.0.3.1.0 | [![dreispt](https://github.com/dreispt.png?size=30px)](https://github.com/dreispt) | Compute Sales Tax using the Avalara Avatax Service
[account_avatax_sale_oca](account_avatax_sale_oca/) | 14.0.1.4.0 | [![dreispt](https://github.com/dreispt.png?size=30px)](https://github.com/dreispt) | Sales Orders with automatic Tax application using Avatax
