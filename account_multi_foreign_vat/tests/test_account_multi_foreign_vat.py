...
class TestAccountMultiForeignVat(TransactionCase):
    ...
    def test_account_multi_foreign_vat(self):
        ...
        self.assertEqual(self.fiscal_position_2.foreign_vat, self.fiscal_position_1.foreign_vat)
        self.assertEqual(self.fiscal_position_2.country_id, self.fiscal_position_1.country_id)
