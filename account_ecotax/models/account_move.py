...
class AccountMove(models.Model):
    ...
    def _get_tax_totals(
        ...
        data = list(res["groups_by_subtotal"].get(self.env._("Untaxed Amount")) or [])
        data.append(
            {
                "tax_group_name": self.env._("Included Ecotax"),
        ...
        res["groups_by_subtotal"][self.env._("Untaxed Amount")] = data
        return res
