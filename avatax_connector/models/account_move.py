...
class AccountMove(models.Model):
                ...
                if avatax_config.on_line:
                    ...
                    for line in lines:
                        ...
                        ol_tax_amt = account_tax_obj._get_compute_tax(
                            avatax_config,
                            self.invoice_date or time.strftime("%Y-%m-%d"),
                            self.name,
                            doc_type,  # 'SalesOrder',
                            self.partner_id,
                            ship_from_address_id,
    ...
    def create_lines(self, sign=1):
        ...
        for line in self.invoice_line_ids:
            ...
            # if line.product_id:
            tax_code = (
                line.product_id.tax_code_id and line.product_id.tax_code_id.name
            ) or None
            # else:
    ...
    def button_draft(self):
        ...
        for invoice in self:
            ...
            has_avatax_tax = invoice.mapped("invoice_line_ids.tax_ids.is_avatax")
            if (
...
class AccountMoveLine(models.Model):
    ...
    tax_amt = fields.Float(string="Avalara Tax", help="Tax computed by Avalara",)
