...
class SaleOrder(models.Model):
    ...
    def _amount_all(self):
        ...
        for order in self:
            ...
            order.update(
                {
                    "amount_untaxed": order.pricelist_id
                    and order.pricelist_id.currency_id.round(amount_untaxed)
                    or amount_untaxed,
                    "amount_tax": order.pricelist_id
                    and order.pricelist_id.currency_id.round(amount_tax)
                    or amount_tax,
